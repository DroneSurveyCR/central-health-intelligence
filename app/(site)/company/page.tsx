    ...
    <>
      ...
      <section className="mkt-section mkt-hero">
        <div className="mkt-wrap">
          ...
          <h1 className="mkt-display" style={{ maxWidth: "16ch" }}>
            ...
            <div className="mkt-device">
              <div style={{ padding: 18 }}>
                {[
                  ...
                  <div key={k} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, padding: "13px 0", borderBottom: "1px solid var(--line)", fontSize: 14 }}>
                    <span>{k}</span>
