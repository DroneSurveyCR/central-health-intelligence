...
// Patient notification feed. getCurrentPatient + the RLS session client scope to
// the practice; we additionally filter recipient_patient_id = me.id so a patient
// only ever sees notifications addressed to them (never practice-wide/staff rows).
...
export default async function PatientNotificationsPage() {
  ...
  // Only notifications addressed to me. Unread first, then newest first.
  ...
  return (
    <div style={{ maxWidth: 760 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
        ...
        {unread > 0 && <span className="badge unread">{unread} unread</span>}
      ...
      <p className="muted">Reminders and milestones from your care team, unread first.</p>
